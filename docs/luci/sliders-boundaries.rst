...
=================================
 * **минимальное значение =** размер физического диапозона группы томов
   *(physical extent size of volume group)*
 * **максимальное значение =** свободное место на группе томов
 * **шаг слайдера =** размер физического диапозона группы томов
   *(physical extent size of volume group)*
 * **значение по умолчанию =** размер физического диапозона группы том
   *(physical extent size of volume group)*
 ...
 * **шаг слайдера =** размер физического диапозона группы томов
   *(physical extent size of volume group)*
 * **значение по умолчанию =** размер физического диапозона группы томов
   *(physical extent size of volume group)*
